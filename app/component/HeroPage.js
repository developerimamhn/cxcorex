          ...
          <div className='relative z-[2]'>
              <div className='pt-[80px] sm:pt-[81px] md:pt-[150px] xl:pt-[180px] 2xl:pt-[200px]  px-[24px] sm:px-0 container mx-auto w-full flex justify-start relative pb-[50px] sm:pb-[70px] md:pb-[90px] lg:pb-[110px] xl:pb-[140px] 2xl:pb-[180px]'>
                <div className='grid grid-cols-1 sm:grid-cols-2 items-center justify-between gap-[20px] sm:gap-[24px] md:gap-[32px] lg:gap-[36px] xl:gap-[40px] 2xl:gap-[43px]'>
                  <div>
                    <span className='flex items-center justify-start gap-1.5 sm:gap-2 unslesvisaobn text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[16px] 2xl:text-[20px]'>
                    ...
                    <h2 className='decentrowea text-[32px] sm:text-[36px] md:text-[40px] lg:text-[48px] xl:text-[64px] 2xl:text-[80px] pt-[11px] sm:pt-[12px] md:pt-[13px] lg:pt-[14px] xl:pt-[15px] 2xl:pt-[16px]'>Decentralized <div className='expersowrks'> World Experience 
                      </div> Reimagined </h2>
                    <p className='disbytitsuser text-[13px] sm:text-[14px] md:text-[15px] lg:text-[16px] xl:text-[20px] 2xl:text-[24px] pt-[13px] sm:pt-[14px] md:pt-[15px] lg:pt-[16px] xl:pt-[20px] 2xl:pt-[24px] pb-[16px] sm:pb-[20px] md:pb-[24px] lg:pb-[32px] xl:pb-[36px] 2xl:pb-[40px]'>Is distinguished by its user-friendly design requiring minimal learning curve, robust community features, advanced transaction.</p>
                    <button className='buttonauditelt cursor-pointer text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[16px] 2xl:text-[20px] flex items-center justify-center h-[35px] md:h-[40px] lg:h-[50px] xl:h-[60px] 2xl:h-[70px] px-[16px] sm:px-[20px] md:px-[24px] lg:px-[32px] xl:px-[36px] 2xl:px-[40px] group gap-[7.50px] '>
