  ...
  useEffect(() => {
    ...
    return ( 
        <div id='Ecosystem' ref={wrapperRef} className='relative '>
                      <svg className="h-full absolute bottom-0 right-0 z-[1] sm:block hidden" viewBox="0 0 441 1316" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg className="h-full absolute bottom-0 right-0 z-[1] sm:block hidden" viewBox="0 0 1185 1311" fill="none" xmlns="http://www.w3.org/2000/svg">
